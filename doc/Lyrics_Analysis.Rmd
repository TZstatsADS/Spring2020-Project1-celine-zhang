...
Nowadays, music is a big part of people's life. Lyrics is said to be the soul of music. There are so many kinds of music, like Rock and Metal, but, as for me, I am not familiar with all kinds of genres. So I am trying exploring the lyrics, which is the key part of music, to understand the underlying things behind the music's genre.
...
From the histogram, we notice that the number of words in hip-hop music is commonly more than that in other genres. Also, in the boxplot, we can see that the song with the most words is from hip-hop and the song with the least words is from eletronic. From the violin-plot, it is shown that, the number of words in the genres, such as country, jazz and rock music, is kind of consistent as time goes by. The Eletronic music has the longest span in the number of words.I am trying to figure out the relationship between the distribution of number of lyrics and the decades, so I pick the Metal Music as the example.
...
lyrics.metal
```
According to the ridges plot, it is evident that the length of lyrics is increasing and the distribution of it is more concentrated as the year goes by.
...
```
As we can see, except for Metal, the love is used most frequently by all the genres, and love is mentioned about 80000 times, which is the highest in all genres. However, in metal music, the terms, life and time, are mentioned more than the term love, and I guess this is resulted by the core of metal music, the aggressive attitude about life rather than the joy of the world. We also can conclude this from the word cloud of metal music's lyrics
...
The word clouds contains the top 200 frequently used terms in metal music, and it is obivious that most of terms expresses negative feelings, like die, pain and lie. Hence, I guess the major emotion of metal music is negative. In order to explore the emotion underlying the metal music, we use the sentimental analysis.
...
```
As we can see, the top 5 major feeling of the metal music is negative, positive, fear, sadness and anger, and four of five suggest the darkness of life. Hence, we can infer that the reason why metal music is less often to mention the term love is that its major emotion is the negative. We also can use the sentiment analysis on all the genres to prove that.
...
```
As the result shown, in the sentimental analysis, the term love is corresponding to joy and positive emotion, and also considering what the heatmap is shown，compared to other genres, the metal music has more preference on the negative emotion rather than the joy and positive emotion. So, this is why the metal music relatively rarely mentions the term love.
